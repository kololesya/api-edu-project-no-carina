...
public class UserTestData {
    ...
    public static final String UPDATED_NAME = TestDataConfig.get("user.updateName");
    public static final String UPDATED_STATUS = TestDataConfig.get("user.updateStatus");
