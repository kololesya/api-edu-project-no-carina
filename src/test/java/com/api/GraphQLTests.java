...
public class GraphQLTests extends BaseGraphQLTest {
    ...
    public void getUserByIdTest() {
        Map<String, String> expectedData = UserFactory.createDefaultUserData();
    ...
    public void updateUserTest() {
        Map<String, String> originalData = UserFactory.createDefaultUserData();
        int userId = graphQLService.createUserAndGetId(originalData);
        Map<String, String> updatedData = UserFactory.updateUserData();
